...
n = int(input('Укажите длину первого множества : '))
m = int(input('Укажите длину второго множества : '))

list1 = [int(random.randint(1, 100)) for _ in range(int(n))]
list2 = [int(random.randint(1, 100)) for _ in range(int(m))]

print(list1)
print(list2)

list_res = sorted(set(list1 + list2))
print(list_res)
...
for i in range(len(list) - 1):
    list_count.append(list[i - 1] + list[i] + list[1 + 1])
